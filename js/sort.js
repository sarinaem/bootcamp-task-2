...
//       dateOrder = "desc";  
//     }
//     axios.get(`http://localhost:3000/transactions?_sort=date&_order=${this.dateOrder}`).then((res) => {
...
//       dateOrder = "desc";  
//     }
//     axios.get(`http://localhost:3000/transactions?_sort=date&_order=${dateOrder}`).then((res) => {
//         allTransactionDta = res.data;
//         creatTable(allTransactionDta);
//       })
//       .catch((err) => console.log(err));
